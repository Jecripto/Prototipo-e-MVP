...
<br><br>
 ...
 <h2>Tela 3 (Página de Pesquisa)</h2>
...
Nesta página terá 1 conteiner, 3 edit text, 1 Button, 1 text e uma imagem do Parque da Independência:
 ...
 - A imagem será apenas alocada a está página
...
<br>
Nesta página terá 1 conteiner, 2 edit text, 1 Button, 1 text e uma imagem noturna da Cidade de São Paulo. Tudo será muito parecido com a tela de cadastro, 
porém agora com o objetivo de efetuar o login do cliente:

- Começando pelo Container, ele será branco e ficará na parte de fundo da página
- As edits texts seram para colocar o Usuário, Senha e Gmail
- O único Button será para colocar o cadastro
